        ...
        {tasks.map((task) => {
          ...
          return (
            <div
              ...
              className={`p-3 rounded cursor-pointer transition ${selected ? "bg-blue-50 border-2 border-blue-500" : "bg-gray-50 hover:bg-gray-100 border border-gray-200"
                }`}
            >
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 ml-2">
                  {ready ? (
                    ...
                    <FontAwesomeIcon icon={faSpinner as any} className="text-gray-400" />
                  )}
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                    ...
                    className={`px-2 py-1 text-xs rounded ${task.active ? "bg-green-100 text-green-700" : "bg-gray-200 text-gray-600"
                      }`}
                  >
